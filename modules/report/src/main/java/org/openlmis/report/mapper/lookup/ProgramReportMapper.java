...
public interface ProgramReportMapper {
    ...
    //@Select("SELECT id, name, description, code FROM programs WHERE id in (1, 3, 5, 6, 10);")
    @Select("SELECT id, name, description, code FROM programs WHERE id in (16, 17, 18, 19, 20, 21, 22);")
